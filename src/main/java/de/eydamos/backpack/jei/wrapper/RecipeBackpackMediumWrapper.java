...
public class RecipeBackpackMediumWrapper extends BlankRecipeWrapper implements IShapedCraftingRecipeWrapper {
    @Override
    public int getWidth() {
        return 1;
    }
    ...
    public void getIngredients(IIngredients ingredients) {
        ...
        ingredients.setOutput(ItemStack.class, new ItemStack(BackpackItems.backpack, 1, EBackpack.MEDIUM.getDamage()));
    }
}
