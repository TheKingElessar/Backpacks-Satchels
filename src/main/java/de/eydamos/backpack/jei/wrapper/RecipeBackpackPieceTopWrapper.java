...
public class RecipeBackpackPieceTopWrapper extends BlankRecipeWrapper implements IShapedCraftingRecipeWrapper {
    @Override
    public int getWidth() {
        return 3;
    }
    ...
    public void getIngredients(IIngredients ingredients) {
        ...
        ingredients.setOutput(ItemStack.class, EItemStack.getItemStack(BackpackItems.backpack_piece, 1, EPiece.TOP.getDamage()));
    }
}
