...
public enum EItem {
    ...
    FRAME_WOOD(Constants.Items.FRAME, "frame_wood", 1, true, 0),
    FRAME_STONE(Constants.Items.FRAME, "frame_stone", 1, true, 1),
    FRAME_IRON(Constants.Items.FRAME, "frame_iron", 1, true, 2),
    ...
    EItem(Constants.Items item, String unlocalizedName, int stackSize, boolean hasSubTypes, int damage) {
        this.item = item;
